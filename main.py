# This file was created by Andrew Fore
# source: https://www.youtube.com/watch?v=Z1-ACw9gBz4
...
while True:
    ...
    clock.tick(60)
    #  what happens when the ball passes the paddle and into the goal
